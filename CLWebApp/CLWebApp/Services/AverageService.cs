...
namespace CLWebApp.Services
{
    ...
    public class AverageService
    {
        ...
        public void Clear(AverageViewModel model)
        {
            model.Bats = "0";
            model.Hits = "0";
            model.Average = "";
        ...
        public double CalcAverage(double batNum, double hitNum, bool chkMou)
        {
            // 打率を計算
        ...
        /// </returns>
        public string AveFormat(double averageVal, bool chkMou)
        {
            if (chkMou)
            {
